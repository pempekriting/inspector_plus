      ...
      style={{
        background: copied
          ...
          : isDark
            ? '#1f1f23'
            : '#f0f0f0',
        color: copied ? (isDark ? '#34d399' : '#047857') : isDark ? '#71717a' : '#666666',
        border: copied
          ? isDark
            ? '2px solid #34d399'
            : '2px solid #047857'
...
const STABILITY_COLORS: Record<
  number,
  { bg_dark: string; bg_light: string; border: string; text: string }
> = {
  5: {
    bg_dark: 'rgba(52, 211, 153, 0.15)',
    bg_light: 'rgba(4, 120, 87, 0.12)',
    border: '#10b981',
    text: '#10b981',
  },
  4: {
    bg_dark: 'rgba(59, 130, 246, 0.15)',
    bg_light: 'rgba(29, 78, 216, 0.12)',
    border: '#3b82f6',
    text: '#3b82f6',
  },
  3: {
    bg_dark: 'rgba(250, 204, 21, 0.15)',
    bg_light: 'rgba(180, 83, 9, 0.12)',
    border: '#facc15',
    text: '#facc15',
  },
  2: {
    bg_dark: 'rgba(249, 115, 22, 0.15)',
    bg_light: 'rgba(194, 65, 12, 0.12)',
    border: '#f97316',
    text: '#f97316',
  },
  1: {
    bg_dark: 'rgba(248, 113, 113, 0.15)',
    bg_light: 'rgba(220, 38, 38, 0.12)',
    border: '#f87171',
    text: '#f87171',
  },
};
...
const LocatorRow = memo(function LocatorRow({
  ...
  return (
    <div className="flex items-start gap-2 py-2 px-2 -mx-2 rounded cursor-default hover:bg-white/[0.04] transition-colors">
      <div
