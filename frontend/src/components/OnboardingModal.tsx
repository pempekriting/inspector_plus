  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-[11px] leading-relaxed" style={{ color: textSecondary, maxWidth: '36ch' }}>
        Inspect elements, execute commands, and run accessibility audits on connected devices — all
        from one window.
      </p>
      ...
      <div className="space-y-2">
        {[
          ...
          <div key={text} className="flex items-center gap-2">
            ...
            <span className="text-[11px]" style={{ color: textPrimary }}>
              {text}
            </span>
          </div>
        ))}
          ...
          <ol className="text-[10px] space-y-1.5" style={{ color: textSecondary }}>
            {[
              ...
              <li key={i} className="flex items-start gap-2">
                <span
                  className="font-mono font-bold mt-0.5 w-3 flex-shrink-0"
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        {features.map(({ title, desc, key }) => (
          ...
          >
            <span
              className="text-[10px] font-mono font-bold w-5 flex-shrink-0"
              style={{ color: textTertiary }}
            >
              {key}
            </span>
            <div className="flex-1 min-w-0">
              <span className="text-[11px] font-medium block" style={{ color: textPrimary }}>
                {title}
              </span>
          ...
          >
            ...
            <ul className="space-y-1">
              {solutions.map((s, i) => (
                <li key={i} className="flex items-start gap-2">
                  <span
                    className="text-[9px] font-mono mt-0.5 w-3 flex-shrink-0"
                    style={{ color: textTertiary }}
                  >
                    {String(i + 1)}.
                  </span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div className="p-5">{step?.content({ isDark })}</div>
