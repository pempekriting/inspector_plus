          ...
          {devices.map((device) => {
            ...
            return (
              <button
                ...
                style={{
                  color:
                    selectedDevice === deviceKey ? 'var(--accent-cyan)' : 'var(--text-secondary)',
                  background: selectedDevice === deviceKey ? 'var(--bg-tertiary)' : 'transparent',
              ...
              >
                ...
                <div className="flex flex-col min-w-0 flex-1 gap-0.5">
                  <div className="flex items-center gap-2 min-w-0">
                    <span className="truncate font-bold flex-1 min-w-0">
