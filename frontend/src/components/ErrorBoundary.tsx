    ...
    >
      ...
      >
        <div
          ...
          style={{
            background: isDark ? 'rgba(251, 113, 133, 0.2)' : 'rgba(220, 38, 38, 0.15)',
          }}
        >
          <svg
            className="w-8 h-8"
        ...
        <h2 className="text-lg font-bold mb-2" style={{ color: isDark ? '#e4e4e7' : '#1a1a1a' }}>
          Something went wrong
        </h2>
        <p className="text-sm mb-4" style={{ color: isDark ? '#71717a' : '#666666' }}>
